...
- **`methodology.md`** — experimental design: task, missingness mechanisms, model-selection procedure, metrics, and how the RQs map to code.
- **`results_rq1_rq2.md`** — rate sweep (RQ1) and MNAR-Y strength sweep (RQ2) results.
