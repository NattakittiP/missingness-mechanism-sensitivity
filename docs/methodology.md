...
- **Prediction landmark / lab observation window**: first 24 hours of admission (adopted analysis convention for this study). Every `lab_*` feature and every admission-context/demographic feature is treated as available at this landmark.
